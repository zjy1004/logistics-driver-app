      ...
      <div slot="drawer">
        <div class="drawer-con">
          ...
          <ul class="menu-setting-list">
            ...
            <!-- <li v-else @click="clickService"><a :href="'tel:'+telNum"><i class="phone"></i><span>客服</span></a></li> -->
            <li v-else @click="clickService"><a :href="'tel:'+telNum"><i class="phone"></i><span>客服1</span></a></li>
